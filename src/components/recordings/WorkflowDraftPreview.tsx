...
interface WorkflowDraftPreviewProps {
  ...
  onOpenWorkflowLearning?: (workflowId: string) => void;
}
    ...
    <div className="rounded-2xl border border-purple-200 bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {publishedWorkflowId && onOpenWorkflowLearning && (
            <Button variant="secondary" size="sm" onClick={() => onOpenWorkflowLearning(publishedWorkflowId)}>
              <GitBranch size={14} className="mr-1" />
              Open in Workflow Learning
            </Button>
          )}
          {onPublish && (
