      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-blue-700">
            <FileText size={18} />
            <span className="text-xs font-semibold uppercase tracking-wide">Test Run Draft Preview</span>
          </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {onCreateTemplate && (
            <Button variant="secondary" size="sm" onClick={onCreateTemplate} loading={creatingTemplate}>
          ...
          {onPublish && (
            <Button onClick={onPublish} size="sm" loading={publishing} disabled={!!publishedPresetId}>
              <Upload size={14} className="mr-1" />
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,0.7fr)]">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div className="text-xs font-semibold uppercase tracking-wide text-gray-500">Preset Target</div>
            <div className="mt-3 space-y-2 text-sm text-gray-700">
              ...
              <div>Recorded Status: {draft.summary?.response_status || 'Unknown'}</div>
