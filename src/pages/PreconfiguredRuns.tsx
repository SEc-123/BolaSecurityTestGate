    ...
    <div className="space-y-6 p-8">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            API recordings land here first so we can edit variables, assertions, environment binding, and promotion targets before turning them into presets, templates, or formal test runs.
          </p>
        </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Test Run Drafts</h2>
        </div>
