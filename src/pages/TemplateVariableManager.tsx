...
export function TemplateVariableManager() {
  ...
  const [patchDataSource, setPatchDataSource] = useState<'checklist' | 'account_field' | 'security_rule' | ''>('');
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <Select
                    ...
                    onChange={(e) => {
                      setPatchDataSource(e.target.value as 'checklist' | 'account_field' | 'security_rule' | '');
                      setPatchChecklistId('');
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-amber-700 space-y-1">
                {previewWarnings.map((warning, index) => (
                  <li key={index}>
                    {warning.template_name}: {warning.variable_name} - {warning.reason}
                  </li>
                ))}
              </ul>
            </div>
